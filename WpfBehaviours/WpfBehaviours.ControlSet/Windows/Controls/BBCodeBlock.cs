using WpfBehaviours.ControlSet.Windows.Controls.BBCode;
using WpfBehaviours.ControlSet.Windows.Navigation;
using System;
        ...
        : TextBlock
    {
        ...
        private void OnRequestNavigate(object sender, RequestNavigateEventArgs e)
        {
            try {
                ...
                ModernDialog.ShowMessage(error.Message, WpfBehaviours.ControlSet.Resources.NavigationFailed, MessageBoxButton.OK);
            }
        }
