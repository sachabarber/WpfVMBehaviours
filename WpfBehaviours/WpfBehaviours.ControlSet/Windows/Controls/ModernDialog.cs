using WpfBehaviours.ControlSet.Presentation;
        ...
        public Button OkButton
        {
            get
            {
                if (this.okButton == null) {
                    this.okButton = CreateCloseDialogButton(WpfBehaviours.ControlSet.Resources.Ok, true, false, MessageBoxResult.OK);
                }
        ...
        public Button CancelButton
        {
            get
            {
                if (this.cancelButton == null) {
                    this.cancelButton = CreateCloseDialogButton(WpfBehaviours.ControlSet.Resources.Cancel, false, true, MessageBoxResult.Cancel);
                }
        ...
        public Button YesButton
        {
            get
            {
                if (this.yesButton == null) {
                    this.yesButton = CreateCloseDialogButton(WpfBehaviours.ControlSet.Resources.Yes, true, false, MessageBoxResult.Yes);
                }
        ...
        public Button NoButton
        {
            get
            {
                if (this.noButton == null) {
                    this.noButton = CreateCloseDialogButton(WpfBehaviours.ControlSet.Resources.No, false, true, MessageBoxResult.No);
                }
        ...
        public Button CloseButton
        {
            get
            {
                if (this.closeButton == null) {
                    this.closeButton = CreateCloseDialogButton(WpfBehaviours.ControlSet.Resources.Close, true, false, MessageBoxResult.None);
                }
